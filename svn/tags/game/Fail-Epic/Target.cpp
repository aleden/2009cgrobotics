...
int FindTwoColors(TrackingThreshold td1, TrackingThreshold td2, 
		SecondColorPosition position, ParticleAnalysisReport *par1,float &distance)
{ 	
	ParticleAnalysisReport par2;
	int success =  FindTwoColors(td1, td2, position, par1, &par2,distance);
	return success; 
}

int FindTwoColors(TrackingThreshold td1, TrackingThreshold td2, 
		SecondColorPosition position, ParticleAnalysisReport *par1, 
		ParticleAnalysisReport *par2,float &distance)
{		
	return FindTwoColors(td1, td2, position, par1, par2, 3,distance);
}
int FindTwoColors(TrackingThreshold td1, TrackingThreshold td2, 
		SecondColorPosition position, ParticleAnalysisReport *par1,
		ParticleAnalysisReport *par2, int numberHits,float &distance)
{
				...
				if (secondTrackReport->center_mass_y < firstTrackReport->center_mass_y) 
					{	
						...
						{	
							...
							// THIS ADDED BY YF
							xDistance = firstTrackReport->center_mass_x_normalized -
							secondTrackReport->center_mass_x_normalized;
							
							yDistance = firstTrackReport->center_mass_y_normalized -
							secondTrackReport->center_mass_y_normalized;
